...
export function CourseFormDialog({
  ...
  const getFieldEnabledState = () => {
    ...
    return {
      ...
      nameEs: languageEnabled.nameEs && (!course.nameEs || course.nameEs.trim() === ""),
      nameEn: languageEnabled.nameEn && (!course.nameEn || course.nameEn.trim() === ""),
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Label
                  ...
                  className="text-sm font-semibold text-foreground"
                >
                  Course Category <span className="text-destructive">*</span>
                </Label>
                <Select
                ...
                >
                  ...
                  <SelectContent className="bg-background border-border shadow-lg">
                    <SelectItem value="humanities" className="hover:bg-muted/80">
                      Humanities
                    </SelectItem>
                    <SelectItem value="core" className="hover:bg-muted/80">
                      Core
                    </SelectItem>
                    <SelectItem value="elective" className="hover:bg-muted/80">
                      Elective
                    </SelectItem>
                    <SelectItem value="general" className="hover:bg-muted/80">
                      General
                    </SelectItem>
                  </SelectContent>
                </Select>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent className="bg-background border-border shadow-lg">
                    <SelectItem value="introductory" className="hover:bg-muted/80">
                      Introductory
                    </SelectItem>
                    <SelectItem value="intermediate" className="hover:bg-muted/80">
                      Intermediate
                    </SelectItem>
                    <SelectItem value="advanced" className="hover:bg-muted/80">
                      Advanced
                    </SelectItem>
                    <SelectItem value="graduate" className="hover:bg-muted/80">
                      Graduate
                    </SelectItem>
                  </SelectContent>
                </Select>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateFormData("corequisites", e.target.value)}
                  placeholder="Enter course codes separated by commas"
                  className="h-11 border-border focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateFormData("syllabus", e.target.value)}
              ...
              <div className="space-y-2">
                <Label
                  ...
                  className="text-sm font-semibold text-foreground"
                >
                  Course Availability <span className="text-destructive">*</span>
                </Label>
                <Select
