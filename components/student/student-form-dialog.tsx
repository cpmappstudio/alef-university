...
export function StudentFormDialog({
      ...
      return {
        ...
        studentProfile: {
          ...
          expectedGraduationDate: student.studentProfile?.expectedGraduationDate
            ? new Date(student.studentProfile.expectedGraduationDate)
                .toISOString()
                .split("T")[0]
            : "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const expectedGraduationDate = formData.studentProfile
        .expectedGraduationDate
      ...
      if (mode === "create") {
        ...
        await adminUpdateStudent({
          ...
          enrollmentDate:
            enrollmentDate ??
            (student?.studentProfile?.enrollmentDate || Date.now()),
          expectedGraduationDate,
          status: formData.studentProfile.status!,
          academicStanding:
            formData.studentProfile.academicStanding || "good_standing",
        });
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateFormData("studentProfile.programId", value)
                      }
                    >
                      <SelectTrigger className="w-full h-11 border-border focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateFormData(
                          "studentProfile.expectedGraduationDate",
                          e.target.value,
                        )
                      }
                      className="h-11 border-border focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateFormData("studentProfile.status", value)
                      }
                    >
                      <SelectTrigger className="w-full h-11 border-border focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateFormData("studentProfile.academicStanding", value)
                      }
                    >
                      <SelectTrigger className="w-full h-11 border-border focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200">
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-muted-foreground">
                            Section{" "}
                            {enrollment.sectionInfo?.groupNumber || "N/A"}
                          </span>
                        </div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {enrollment.periodInfo?.nameEs || "N/A"} • Enrolled:{" "}
                          {new Date(
