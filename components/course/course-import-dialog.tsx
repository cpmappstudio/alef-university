...
export function CourseImportDialog() {
  const t = useTranslations("admin.courses.import");
  ...
  const importCourses = useAction(api.courses.importCoursesFromJSONL);
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      // Call import action
      const importResults = await importCourses({ courses });
