...
interface CourseRemoveDialogProps {
  courseName: string;
  open: boolean;
...
export function CourseRemoveDialog({
  courseName,
  open,
  onOpenChange,
  onConfirm,
  isRemoving,
}: CourseRemoveDialogProps) {
  const t = useTranslations("admin.programs.detail.courseRemoveDialog");
